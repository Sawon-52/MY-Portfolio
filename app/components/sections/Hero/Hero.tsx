      ...
      <div className="flex flex-col justify-center text-center items-center">
        <div className="flex flex-col items-center">
          <div className="flex items-center justify-center  gap-1  my-4">
            <div className="w-12 min-h-1 bg-gradient-to-r from-primary-color to-secondary-color "> </div>
            <div className="flex items-center  text-secondary-color text-xl lg:text-3xl  lg:leading-1.5 font-bold">
              <h4>Hi, I'm</h4>
          ...
          <div>
            <h1 className="text-5xl lg:text-6xl px-10 font-bold bg-gradient-to-r from-primary-color to-secondary-color bg-clip-text text-transparent lg:leading-[80px]">Frontend Web Developer Based in Bangladesh</h1>
          </div>
          <div>
        ...
        <div className="flex items-center justify-center gap-5 flex-wrap my-8">
